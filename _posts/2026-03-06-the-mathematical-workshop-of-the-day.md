...
Let $k$ denote the number of digits equal to $8$ in $N$. Since the sum of the digits of $N$ is $8k$, the condition that $N$ be divisible by $3$ implies that $8k$ must be divisible by $3$. Because
