...
Welcome to my collection of mathematical and actuarial tools.
...
<div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(260px, 1fr)); gap:20px; margin-bottom:40px;">
  ...
  <a href="/tools/soa-fm-practice/" style="text-decoration:none; color:inherit;">
    <div style="border:1px solid rgba(127,127,127,0.22); border-radius:16px; padding:20px; background:rgba(127,127,127,0.06); height:100%;">
      <h3 style="margin-top:0; margin-bottom:10px; color:inherit;">SOA FM Practice</h3>
      <p style="margin:0; color:inherit; opacity:0.8; line-height:1.6;">
  ...
  <a href="/tools/financial-math-calculator/" style="text-decoration:none; color:inherit;">
    <div style="border:1px solid rgba(127,127,127,0.22); border-radius:16px; padding:20px; background:rgba(127,127,127,0.06); height:100%;">
