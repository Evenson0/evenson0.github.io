...
tool_theme: bonds
---
<link rel="stylesheet" href="/assets/css/bond-intelligence.css?v=2">
<div class="bi-shell">
  ...
  <main class="bi-main">
    <section class="bi-inputs"><header><span>01 / Market or manual</span><h2>Choose a bond or enter its terms</h2></header><div class="bi-picker"><label>Market bond<select id="biBond"></select></label><button id="biLoadBond">Load selected bond →</button><p id="biBondMeta">Choose a cached market security, or keep Manual entry to use your own terms.</p></div><div class="bi-fields">
...
<script src="/assets/js/bond-intelligence.js?v=2" defer></script>
