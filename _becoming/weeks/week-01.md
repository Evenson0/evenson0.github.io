...
quests:
  ...
  - domain: english
    ...
    task: Complete one 60-minute general conversation.
    task_fr: Compléter une conversation générale de 60 minutes.

  - domain: physical
    node: physical-process
    task: Complete 4 strength sessions, 3 runs, and aim for 12,000–15,000 steps each day.
    task_fr: Compléter 4 séances de musculation, 3 courses et viser 12 000 à 15 000 pas par jour.
